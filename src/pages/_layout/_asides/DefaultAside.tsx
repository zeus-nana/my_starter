...
const DefaultAside = () => {
	...
	const [doc, setDoc] = useState(
		localStorage.getItem('freuzo_asideDocStatus') === 'true' || false,
	);
					...
					<Card className='m-3 '>
						<CardBody className='pt-0'>
							...
							<Button
								...
								className='w-100'
								onClick={() => {
									localStorage.setItem('freuzo_asideDocStatus', 'false');
									setDoc(false);
								}}>
				...
				<nav aria-label='aside-bottom-menu'>
					<div className='navigation'>
						<div
							...
							onClick={() => {
								localStorage.setItem('freuzo_asideDocStatus', String(!doc));
								setDoc(!doc);
							}}
